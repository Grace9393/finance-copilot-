/**
 * ibmAnnualReports.ts — generated from server/data/ibm-annual-reports.json
 * (kept as a TS module so it bundles cleanly in both the Express server and
 * Vercel serverless functions; the JSON file remains the editable source —
 * re-generate this file after editing it).
 */

import type { IbmDataset } from '../ibmData.js';

export const ibmAnnualReports: IbmDataset = {
  "company": "IBM",
